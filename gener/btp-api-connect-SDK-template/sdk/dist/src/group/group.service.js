...
let GroupService = class GroupService {
    ...
    async addUserRoleColleaction(req, res) {
        try {
            const body = req.body;
            const role = await scim_groups_role_collections_api_1.SCIMGroupsRoleCollectionsApi.addUserRoleUsingPost(body.id, body.group).execute(this.destination);
    ...
    async deleteUserRoleColleaction(req, res) {
        const body = req.body;
        const role = await scim_groups_role_collections_api_1.SCIMGroupsRoleCollectionsApi.deleteUserRoleUsingDelete(body.groupId, body.userId).execute(this.destination);
        return res.send(role);
    }
};
__decorate([
